...
\section{实验规划与设计}
\subsection{任务分配}
{171860551, \text{韩畅：组长,算法设计与实验规划，Pair\_Int类，partitionr类，combiner 类编写，程序调试与优化}}\\ \indent
{171860550, \text{王一之：算法设计与实验规划，程序优化，添加程序代码，主要报告编写，github集中控制}}\\ \indent
{171860549, \text{闫旭芃：算法设计与实验规划,driver类以及代码整合,修改,hadoop集群调试提交，部分报告补充}}\\ \indent
{171840565, \text{李展烁：算法设计与实验规划,mapper类,reducer类,combiner类编写,参与程序优化和代码修改}}
\subsection{任务要求}
